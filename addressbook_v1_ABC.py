...
if __name__ == "__main__":
    ...
    try:
        ...
        print("address book is clean")

    while True:
        MENU = """\n--- Address Book Menu ---
    1. Add/editing contact
    2. Remove contact
    3. Search for contact
    4. Display all contacts
    5. Display all contacts with birthday in next N days:
    6. Quit"""
        menu = PrintMenu()
        menu.print_results(MENU)
